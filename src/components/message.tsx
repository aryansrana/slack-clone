...
const formatFullTime = (date: Date) => {
    ...
    return `${date2.isToday() ? "Today" : date2.isYesterday() ? "Yesterday" : format(date, "MMM d, yyyy") } at ${format(date, "h:mm:ss a")}`; // TODO date of format can be wrong
}
    ...
    const handleUpdate = ({body} : { body: string}) => {
        updateMessage({id, body }, {
            ...
            onError: () => {
                ...
                // TODO: maybe set editing id to null here??
            }
        })
    };
